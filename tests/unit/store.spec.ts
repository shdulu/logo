...
import { testTemplates } from '@/store/templates'
...
describe('test vuex store', () => {
  ...
  describe('test templates module', () => {
    it('should have default templates', () => {
      expect(store.state.templates.data).toHaveLength(testTemplates.length)
    })
  ...
  describe('test editor module', () => {
    ...
    it('add componet should works fine', () => {
      ...
      expect(lastItem?.props.text).toBe('text1111')
    })
